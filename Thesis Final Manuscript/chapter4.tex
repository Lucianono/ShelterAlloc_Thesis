...
\begin{table}[ht]
	\centering
	\caption{XXXXXXXX Evaluation}
	\label{xxxxx}
	\renewcommand{\arraystretch}{1.2} 
	\begin{tabularx}{\linewidth}{|X|c|c|c|}
		\hline
		\textbf{Statement} & \textbf{Mean} & \textbf{VI} & \textbf{SD} \\ \hline
		Question 1 Lorem ipsum dolor is et al ahiu foli ako sihjul ser ty 
		& x.xx & Highly Acceptable & x.xx \\ \hline
		Question 2 Lorem ipsum dolor is et al ahiu foli ako sihjul ser ty 
		& x.xx & Highly Acceptable & x.xx \\ \hline
		Question 3 Lorem ipsum dolor is et al ahiu foli ako sihjul ser ty 
		& x.xx & Highly Acceptable & x.xx \\ \hline
		\textbf{TOTAL MEAN} & \textbf{x.xx} & \textbf{Highly Acceptable} & \\ \hline
	\end{tabularx}
\end{table}
