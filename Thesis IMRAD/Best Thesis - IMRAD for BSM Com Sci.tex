...
\section{Methods}
	...
	\begin{figure}[h!]
		...
		\centering
		\includegraphics[width=0.9\columnwidth]{Context Diagram}
		\label{SystemArch}
	\end{figure}
	...
	\begin{figure}[h!]
		...
		\centering
		\includegraphics[width=0.9\columnwidth]{ERD}
		\label{ERD}
	\end{figure}
	...
	Table \ref{dataSource} presents all the data variables on communities and shelters used in the model, along with their respective sources.
	\begin{table}[h!]
		\centering
...
\section{Results and Discussion}
	...
	\begin{figure}[h!]
		\caption{Dashboard}
		\centering
		\includegraphics[width=0.7\columnwidth]{Chapter 4/dashboard}
		\label{db}
	\end{figure}
	...
	\begin{figure}[h!]
		...
		\centering
		\includegraphics[width=0.7\columnwidth]{Chapter 4/commadvanced}
		\label{commMan}
	\end{figure}
	...
	\begin{figure}[h!]
		...
		\centering
		\includegraphics[width=0.7\columnwidth]{Chapter 4/sheladvanced}
		\label{shelMan}
	\end{figure}
	...
	\begin{figure}[h!]
		...
		\centering
		\includegraphics[width=0.4\columnwidth]{Chapter 4/modelsettings}
		\label{modelSet}
	\end{figure}
	...
	\begin{figure}[h!]
		...
		\centering
		\includegraphics[width=0.7\columnwidth]{Chapter 4/progress}
		\label{solveProg}
	\end{figure}
	...
	\begin{figure}[h!]
		...
		\centering
		\includegraphics[width=0.7\columnwidth]{Chapter 4/alloc report}
		\label{shelAllocRep}
	\end{figure}
	...
	\begin{figure}[h!]
		...
		\centering
		\includegraphics[width=0.7\columnwidth]{Chapter 4/solvesettings}
		\label{solveSet}
	\end{figure}
	...
	\begin{figure}[h!]
		...
		\centering
		\includegraphics[width=0.7\columnwidth]{Chapter 4/alloc report pass}
		\label{passPop}
	\end{figure}
	...
	\begin{figure}[h!]
		...
		\centering
		\includegraphics[width=0.5\columnwidth]{Chapter 4/straight path}
		\label{straightpath}
	\end{figure}
	...
	\begin{figure}[h!]
		...
		\centering
		\includegraphics[width=0.5\columnwidth]{Chapter 4/route path}
		\label{routepath}
	\end{figure}
