...
%--------------------------------------------------------------%
\title{Proposed Thesis Title Goes Here With a Very Long Title Using a Maximum of Fourteen Words}%Type your thesis title here without any line break

\fronttitle{%
	Proposed Thesis Title Goes Here With a Very Long Title Using a Maximum of Fourteen Words
	} 
...
\authorone{Name OF. Student 1}  %<-Re-type individual names here
\authortwo{Name OF. Student 2}  %<-Re-type individual names here
\authorthree{Name OF. Student 3}%<-Re-type individual names here
\authorfour{Name OF. Student 4} %<-Re-type individual names here

\papertype{Thesis Proposal} %papertype can be thesis proposal, 
%thesis or dissertation
\adviser{Thesis Adviser}		%<-thesis adviser
