...
\subsection{Feasibility Checks}
	...
	Condition \ref{f1} checks if shelter j area for level 2 is greater than or equal to their area for level 1, else it doesn't satisfies the logic of having a level 2 shelter with lesser area than its level 1.
	...
	Condition \ref{f2} checks if the user defined number of maximum level 2 shelters is less than to number of maximum shelters, else  it doesn't satisfies the logic of having a more number of level 2 shelters than the total maximum opened shelters
	...
	Condition \ref{f3} checks if there exists a distance from community i to all shelters that is less than or equal to its max distance. If it doesn't exist then community i can't be assigned to any shelter.
	...
	Condition \ref{f4} checks if there exists a level 2 shelter that could accommodate a community i by their population multiplied by the area allotted per individual. If it doesn't exist then there's no shelter that could accommodate community i.
