...
\subsection{Population and Sample}
	...
	The sample size will be computed using Slovin's formula shown in equation \ref{slovin}. This equation will be used to determine the sample size to be used based on known target population. The confidence level is 90\% or 0.1 margin of error. The sample size would be much smaller than the population size, hence conducting the evaluation considering the respondents' working schedule and the time constraints of this study would be feasible.
