	...
	\begin{table}[h]
		...
		\resizebox{\textwidth}{!}{
			\begin{tabular}{|c|c|p{8cm}|}
				...
				xDegrees & Google Map \& LGU interview & Longitudinal coordinates \\ \hline
				yDegrees & Google Map \& LGU interview & Latitudinal coordinates \\ \hline
				Population & Philippine Atlas (2020 population) & Number of individuals living in a community \\ \hline
				AffectedPop & LGU interview (Typhoon Karina 2024) & Number of individuals affected during a disaster \\ \hline
				...
				Cost1 & Assumed 0 since the shelter is already built & Cost for constructing/maintaining a shelter with Area1 \\ \hline
...
\subsection{Evaluation Instrument}
	...
	\textit{Perceived Ease of Use.} This answers on how much a user belies using the system will be efficient and user-friendly. It considers whether the proposed system can be used smoothly with minimal errors and without performance issues.
	...
	\textit{Actual System Use.} This evaluates the overall user experience and their likelihood of using and adopting the system. It assesses whether users will actively and consistently use the system.
...
\subsection{Population and Sample}
	The population of this study will consist of end-users and IT experts. For end-users,  MDRRMO and MSWDO of the municipality of Calumpit. Meanwhile for IT experts, CICT professors from Bulacan State University.  The diversity of perspective of these are important for the comprehensive evaluation of the system’s acceptability.
...
\subsection{Data Processing and Analysis}
	...
	After the data collection, the rating scale will categorize the acceptability levels. Descriptive statistics will be utilized to analyze the collected data. Analysis includes calculating the minimum, maximum, mean, and standard deviation for each category. Formula \ref{mean} shows the mean that computes the average score, and formula \ref{stdDev} shows the standard deviation which shows the dispersion of scores relative to the mean. This use of data allows both the system functionality and its user acceptability to be comprehensively assessed. 
